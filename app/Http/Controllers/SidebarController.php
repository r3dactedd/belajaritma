...
class SidebarController extends Controller
{
    ...
    $currentSidebar = $userSidebarProgress[$currentMaterialIndex]->sidebar;
        ...
        if ($master_type->master_type_name == 'Video') {
            return view('contents.session_video', compact('material', 'currentMaterialIndex', 'previousMaterial', 'nextMaterial', 'previousMaterialId', 'nextMaterialId', 'nextMaterialTitle', 'previousMaterialTitle', 'sidebars', 'id', 'excludeFinal', 'userCourseDetail', 'nextMaterialIndex'));
        } elseif ($master_type->master_type_name == 'PDF') {
            return view('contents.session_pdf', compact('material', 'currentMaterialIndex', 'previousMaterial', 'nextMaterial', 'previousMaterialId', 'nextMaterialId', 'nextMaterialTitle', 'previousMaterialTitle', 'sidebars', 'id', 'excludeFinal', 'userCourseDetail', 'nextMaterialIndex'));
