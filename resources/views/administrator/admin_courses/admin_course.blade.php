                    ...
                    <tbody class="text-md font-light text-gray-600 md:text-lg">
                        @foreach ($data as $data)
                            <tr class="border-b border-opacity-20 bg-white font-medium leading-normal text-gray-600">
                                <td class="px-4 py-2">
                                    <p class="max-h-20 overflow-scroll">{{ $data->course_name }}</p>
                                </td>
                                <td class="px-4 py-2">
                                ...
                                <td class="px-6 py-3 text-center">
                                    <div class="item-center flex justify-center">
                                        <a href="/manager/course/edit/{{ $data->id }}"
        ...
        <div class="relative max-h-full w-full max-w-md">
            <div class="relative rounded-lg bg-white shadow dark:bg-gray-700">
                ...
                <div class="p-6 text-center">
                    ...
                    <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Apakah anda yakin ingin menghapus kursus tersebut?
                    </h3>
