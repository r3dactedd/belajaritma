...
<body class="pb-12 bg-gray-200">
    ...
    @section('content')
            ...
            <div class="container flex flex-col items-start justify-between py-6 mx-auto md:flex-row md:items-center">
                ...
                <form method="post" action ="/manager/course/edit/{{ $data->id }}" enctype="multipart/form-data">
                    ...
                    <div class="mt-6 md:mt-0">
                        <button type="submit"
                            class="flex items-center px-2 py-2 text-sm text-white transition duration-150 ease-in-out bg-indigo-500 rounded-xl hover:bg-yellow-500 focus:outline-none">
        ...
        <div class="container w-full p-6 mx-auto my-auto md:w-9/12">
            @if ($errors->any())
                <div id="toast-default" class="flex items-center p-4 text-gray-500 bg-white rounded-lg w-fit"role="alert">
                    <div>
            ...
            <div class="my-4 bg-white rounded-xl md:flex">
                ...
                <div class="w-full md:w-1/3">
                    ...
                    <div class="h-full p-2 md:py-4 md:pl-8">
                        <div class="w-full mx-auto">
                            <img id="imagePreview" class="w-full p-4 max-h-64 md:px-0"
                                src="{{ asset('uploads/course_images/' . $data->course_img) }}"alt="Course Image" />
                        </div>
                        <div class="max-w-md">
                            <label
                                class="flex flex-col items-center w-48 p-2 tracking-wide bg-white border rounded-lg shadow-lg cursor-pointer text-blue border-blue hover:bg-blue hover:bg-indigo-500 hover:text-white">
                ...
                <div class="w-full h-auto md:mx-2 md:w-2/3">
                    <!-- Profile tab -->
                    <!-- About Section -->
                    <div class="px-6 pt-4 bg-white rounded-xl md:px-12">
                        <label for="courseTitle" class="block mb-2 text-base font-semibold text-gray-900 dark:text-white">
                            Judul Kursus</label>
                        ...
                        <label for="shortDesc" class="block mb-2 text-base font-semibold text-gray-900 dark:text-white">
                        ...
                        <div class="grid grid-row-2 md:grid-cols-2">
                            <div class="flex flex-row items-center justify-between lg:flex-col lg:items-start">
                                <div
                                    class="flex items-center mt-4 mb-3 space-x-2 font-semibold leading-8 text-gray-900 md:mt-0">

                                    <select name="level"
                                        class="w-full px-4 py-2 text-sm font-semibold bg-gray-100 border-transparent rounded-md focus:border-gray-500 focus:bg-white focus:ring-0">
            ...
            <div class="p-4 bg-white shadow-sm rounded-t-xl">
                <label for="courseDesc" class="block mb-4 ml-4 text-base font-semibold text-gray-900 dark:text-white">
            ...
            <div class="p-4 bg-white shadow-sm rounded-b-xl">
                <div class="grid grid-cols-1 md:grid-cols-2">
                    <div>
                        <label for="minSpec"
                            class="block mb-4 ml-4 text-base font-semibold text-gray-900 dark:text-white">
                        ...
                        <div class="grid gap-4 py-4 pl-4 pr-8 md:grid-cols-2">
                            <div class="p-4 bg-white rounded-lg shadow-md">
                                ...
                                <input type="text" name="screen_resolution" id="inputScreenRes"
                                    class="block w-full px-4 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:border-primary-600 focus:ring-primary-600 dark:focus:border-primary-500 dark:focus:ring-primary-500"
            ...
            <div class="flex justify-center">
                <h1 class="mx-8 my-8 text-xl font-semibold text-center">
                    <a href="/manager/course/materiallist/{{ $data->id }}"
                        class="px-4 py-2 font-bold text-white bg-indigo-500 rounded hover:bg-indigo-700">Akses Materi
                        Kursus
                    </a>
                </h1>
                @if ($data->ready_for_publish == 1)
                    <h1 class="mx-8 my-8 text-xl font-semibold text-center">
                        <a data-modal-target="popup-unpublish" data-modal-toggle="popup-unpublish"
                            class="px-4 py-2 font-bold text-white bg-red-500 rounded hover:bg-indigo-700">
                            Unpublish Kursus
                        </a>
                    </h1>
            ...
            <div id="defaultModal" tabindex="-1" aria-hidden="true"
                ...
                <div class="z-50 w-full mx-auto overflow-y-auto bg-white rounded shadow-lg md:w-3/5">
                    <div class="px-2 py-2 overflow-y-auto text-left md:px-6">
