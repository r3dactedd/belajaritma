                    ...
                    <div class="rounded-xl bg-white p-4 shadow-sm">
                        <div class="mx-auto px-4">
                            ...
                            <div class="font-semibold">
                                ...
                                <table class="mx-auto px-4 text-xs text-white">
                                    <colgroup c>
                                        <col>
                                        <col>
                                        <col>
                                    ...
                                    <thead class="bg-gray-200 px-4 leading-normal text-gray-600">
                                        <tr
                                            ...
                                            <th class="px-4 py-2 text-left">Jawaban Tepat</th>
                                    ...
                                    <tbody class="text-md font-light text-gray-600 md:text-lg">
                                        <tr
                                            ...
                                            <td class="px-4 py-2">
                                                <p class="max-h-20 overflow-scroll">1 </p>
                                            </td>
                                            <td class="px-4 py-2">
                                                <p class="max-h-20 overflow-scroll">Dibawah ini yang merupakan penjelasan
                                                    tepat untuk
                                                    Algoritma adalah: </p>
                                            </td>
                                            <td class="px-4 py-2">
                                                <p class="max-h-20 overflow-scroll">A | Prosedur sistematis untuk
                                                    menyelesaikan
                                                    masalah
                                                    matematika dalam
                                                    langkah
                                        ...
                                        <tr
                                            class="border-2 border-opacity-40 bg-white font-medium leading-normal text-gray-600">
                                            <td class="px-4 py-2">
                                                <p class="max-h-20 overflow-scroll">2 </p>
                                            </td>
                                            <td class="px-4 py-2">
                                                <p class="max-h-20 overflow-scroll">Test Question no 2 </p>
                                            </td>
                                            <td class="px-4 py-2">
                                                <p class="max-h-20 overflow-scroll">C | Prosedur sistematis untuk
                                                    menyelesaikan
                                                    masalah
                                                    matematika dalam
                                                    langkah
