                ...
                <div class="md:mx-2 md:w-4/12">
                    ...
                    @php
                        ...
                        if (!$shuffledQuestionIds || session('reshuffled')) {
                            $shuffledQuestionIds = $questionList
                                ->shuffle()
                                ->pluck('id')
                                ->toArray();
                    ...
                    nextButton.addEventListener('click', function() {
                        ...
                        if (questionId) {
                            ...
                            if (existingAnswerIndex !== -1) {
                                ...
                                userAnswers[existingAnswerIndex].answer = selectedAnswer ? selectedAnswer
                                    .value : '';
                                ...
                                const answerData = {
                                    ...
                                    answerDetail: selectedAnswer ? selectedAnswer.parentElement.textContent
                                        .trim() : '',
                                };
