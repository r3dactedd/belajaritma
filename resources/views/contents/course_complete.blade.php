        ...
        <div class="container">
            <div class="congratulation-wrapper">
                <div class="congratulation-contents center-text">
                    ...
                    <h4 class="congratulation-contents-title"> Selamat! </h4>
                    <p class="congratulation-contents-para"> Kamu Berhasil Menyelesaikan Kursus
                        {{ $course->course_name }}!</p>
                        <p class="congratulation-contents-para"> Silahkan ambil sertifikat anda di halaman kursus {{$course->course_name}}!</p>
                    <div class="btn-wrapper mt-4">
                        <a href="/home" class="cmn-btn btn-bg-1 p-3 my-3"> Kembali ke Halaman Utama </a>
                    </div>
                </div>
            </div>
        </div>
