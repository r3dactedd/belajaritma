            ...
            <div class="container mx-auto my-12 grid w-11/12 gap-8 pb-12 sm:grid-cols-1 md:grid-cols-2">
                                ...
                                <div class="my-2 bg-white md:flex md:h-36">
                                    ...
                                    <div class="w-full md:w-2/5">
                                        ...
                                        <div class="h-full bg-white py-2 md:ml-4">
                                            <div class="mx-auto h-full w-full">
                                                <img class="max-h-36 w-full md:h-full"
                                                    src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRaVAp96aY3YqzClvtSiWKKGA40ieCcrVH6Ows1xtm8obkeNUKGzU-Y6_VRNNM0MDuezx8&usqp=CAU"
                                                    alt="e" />
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="p-6">
                                ...
                                <div
                                    ...
                                    <div class="ml-0 mt-4 flex items-end lg:ml-12 lg:mt-0">
                                        ...
                                        <p class="ml-2 text-center text-sm font-normal tracking-normal text-gray-600">12
                                            Jam
                                        </p>
                                    </div>
                                    <div class="ml-0 mt-4 flex items-end lg:ml-12 lg:mt-0">
                ...
                <a href="/courses/4">
                    ...
                    <nav aria-label="Page navigation example">
                        "either this, atau pake builtin pagination dari laravel, ur pick"
