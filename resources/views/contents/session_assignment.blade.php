    ...
    @section('content')
        ...
        <div class="container mx-auto my-4 p-4">
            <div class="no-wrap my-4 md:-mx-2 md:flex">
                ...
                <div class="w-2xl mx-4 rounded-xl bg-white md:mx-12 md:w-9/12">
                    <div class="mx-auto p-6 antialiased">
                        <div class="space-y-4">
                            ...
                            <h2
                                class="text-md lg:text-md relative mx-6 mb-2 w-auto py-2 font-semibold tracking-normal text-gray-800">
