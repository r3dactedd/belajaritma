    ...
    @section('content')
        ...
        <div
            ...
            {{-- <div class="row">
              ...
              @foreach ($data as $data)
              <div class="cursor-pointer rounded-xl border border-gray-200 bg-white shadow transition duration-150 ease-in-out hover:shadow-lg">
                ...
                <div class="h-full w-full items-stretch pt-5">
                    ...
                    <form action="/courses/{{$data->id}}" method="get">
                        <button
                            class="flex items-center rounded bg-blue-400 mb-6 ml-5 px-5 py-2 text-sm text-white transition duration-150 ease-in-out hover:bg-yellow-500 focus:outline-none" action="/courses/{{$data->id}}" method="get">
