                        ...
                        <div class="space-y-4">
                            ...
                            <a href="/forum/course/1/thread/1" class="flex px-2 hover:bg-gray-200">
                                ...
                                <div class="flex-1 rounded-lg px-4 py-2 text-2xl leading-relaxed">
                                    <strong>Its you!</strong> <span class="ml-2 text-lg text-gray-400">Date Create
                                        Thread</span>
                                    <p class="text-sm">
                                        ...
                                        exercitation
                                        ullamco
                                        LIMIT CHARSNYA OR SUMSHIT your own discussion
                                    </p>
                                    <div class="mt-4 flex items-center">
                                        ...
                                        <div class="ml-4 mr-2 flex -space-x-2">
