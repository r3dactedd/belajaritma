            ...
            <div class="container flex flex-col items-start justify-between py-6 mx-auto md:flex-row md:items-center">
                <div>
                    <h4 class="inline text-2xl font-bold leading-tight text-gray-800">
                        <a href="/forum/course/{{ $data->course_id }}" class="flex items-center" href="#">
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="p-6">
                        <form method="POST"
                            ...
                            @csrf
                            @method('DELETE')
                            <h2 class="mb-4 text-xl font-bold text-gray-900 dark:text-white">Alasan Pemblokiran Forum</h2>
                            <input type="text" name="reason_delete" id="inputReasonDelete"
                                ...
                                placeholder="Tulis alasan blokir forum" required="">
