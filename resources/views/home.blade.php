...
<body class="bg-gray-200 pb-12">
    ...
    @endsection
    @section('content')
        <div class="" style="background-image: url(/storage/image/bg4.svg);opacity: 0.8;">
        ...
        <!-- card 2 -->
        <div class="container mx-auto mb-12 mt-2 w-11/12">
            ...
            <div class="container mx-auto grid w-11/12 gap-8 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                <div class="flex items-center rounded bg-white px-8 py-6 shadow">
                    <div class="rounded bg-indigo-600 p-4">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-discount"
