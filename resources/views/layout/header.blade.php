    ...
    <div class="container mx-auto flex h-16 items-center justify-between lg:items-stretch">
        <div class="flex h-full items-center">
            ...
            <ul class="hidden h-full items-center lg:flex">
                ...
                <li
                    class="text-md mx-10 flex h-full cursor-pointer items-center font-semibold tracking-normal text-gray-800">
                    <a href="/courses">Kursus</a>
                </li>
                <li
                    class="text-md mr-10 flex h-full cursor-pointer items-center font-semibold tracking-normal text-gray-800">
