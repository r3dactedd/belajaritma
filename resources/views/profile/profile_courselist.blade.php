        ...
        <div class="flex items-center">
            <p class="text-lg font-bold leading-5 tracking-normal text-indigo-600">
                <a id="inProgressButton"
                    class="bg-selected inline-block rounded-xl bg-indigo-600 px-4 py-2 text-sm font-semibold text-white hover:bg-green-400">Sedang
                    Dipelajari</a>
            </p>
        </div>
        <div class="flex items-center">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            inProgressButton.addEventListener('click', function() {
                courseCards.forEach(function(card) {
                    ...
                    console.log('Course ID:', card.getAttribute('href'), 'Completed:', isCompleted);
